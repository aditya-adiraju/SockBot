...
class PLAYER:
    HEADER = f"{"player_id":<20}{"player_name":<30}{"group_name":<15}{"secret_word":<20}{"ELIMINATED"}"
    ...
    def __str__(self):
        ...
        return f"{self.player_id:<20}{self.player_name:<30}{self.group_name:<15}{secret:<20}{self.eliminated}"
